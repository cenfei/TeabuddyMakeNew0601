 ...
 */
public class SZ_PayPopwindow_ShareBottom {
...
boolean boolFav;
    ...
    public void showPopwindow(final Activity activity, View relView, final CallBackPayWindow callBackPayWindow) {
        ...
        View view = inflater.inflate(R.layout.share_bottom_popwindow, null);
...
//        }
        ...
        LinearLayout     rb_qqzone_line = (LinearLayout) view.findViewById(R.id.rb_qqzone_line);

        rb_qqzone_line.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //从相册中选择
                callBackPayWindow.handleCallBackQqZone();
...
//        choose_photo_src.setText("从相册中选择");
        ...
        TextView   rb_cancel_id = (TextView) view.findViewById(R.id.rb_cancel_id);

        rb_cancel_id.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                closePopupWindow(activity);
            }

 ...
 */
public class FoxProgressbarInterfaceHot {
    ...
    FoxHotCallback foxHotCallback;
int foxtime=0;
    public interface  FoxHotCallback{
        public void foxhotCallback();
    }


    public void startProgressBarDialog(Dialog dialog,int foxtime,Context context,String comment,FoxHotCallback foxHotCallback) {
       this.foxHotCallback=foxHotCallback;
      this.foxtime=foxtime;
...
//            dialog.show();
    ...
    public void startProgressBar(Context context,String comment,int foxtime,FoxHotCallback foxHotCallback) {
        this.foxHotCallback=foxHotCallback;
        this.foxtime=foxtime;
...
if(writehandler!=null&&runnable!=null)
        writehandler.removeCallbacks(runnable);

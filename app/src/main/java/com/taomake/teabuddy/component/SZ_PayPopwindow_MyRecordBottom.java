 ...
 */
public class SZ_PayPopwindow_MyRecordBottom {
    ...
    LinearLayout rb_play_line,rb_collect_line,rb_share_line,rb_apply_line,rb_delete_line;
    /**
     * @param view
     */
    public void initUi(final Activity activity, View view, View relView) {
        ...
        rb_collect_text.setText("编辑");
        ImageView rb_collect_img = (ImageView) view.findViewById(R.id.rb_collect_img);

        rb_collect_img.setImageDrawable(context.getResources().getDrawable(R.drawable.rc_update));




        rb_delete_line = (LinearLayout) view.findViewById(R.id.rb_delete_line);
        rb_delete_line.setVisibility(View.VISIBLE);
...
//        choose_photo_src.setText("从相册中选择");
        ...
        rb_collect_line.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //从相册中选择
                callBackPayWindow.handleCallBackUpdate();
                closePopupWindow(activity);

            }
        });
        rb_delete_line.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                //从相册中选择
                callBackPayWindow.handleCallBackDelete();
                closePopupWindow(activity);
...
//    }
    ...
    public interface CallBackPayWindow {
        ...
        void handleCallBackUpdate();
        void handleCallBackDelete();

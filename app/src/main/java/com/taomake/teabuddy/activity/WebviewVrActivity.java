...
public class WebviewVrActivity extends Activity implements
        OnClickListener {
    ...
    private com.tencent.smtt.sdk.WebView wb;
...
//        quitFullScreen();
    ...
    private void findview() {
        ...
        if (title != null) {
            ...
            title_text.setTextSize(TypedValue.COMPLEX_UNIT_SP, 17);

        }

        wb = (com.tencent.smtt.sdk.WebView) findViewById(R.id.webview);
//        wb.setScrollBarStyle(View.SCROLLBARS_INSIDE_OVERLAY);

//        if (downLoad != null && !downLoad.equals("")) {
//            wb.setDownloadListener(new MyWebViewDownLoadListener());
//        }
        com.tencent.smtt.sdk.WebSettings webSettings = wb.getSettings();
...
//        } else {
        ...
        wb.setWebViewClient(
                new com.tencent.smtt.sdk.WebViewClient() {


                    public boolean shouldOverrideUrlLoading(com.tencent.smtt.sdk.WebView view, String url) { // 重写此方法表明点击网页里面的连接还是在当前的webview里跳转，不跳到浏览器那边
...
//            wb.setWebViewClient(new WebViewClient());
        if (url != null) {
//            wb.loadUrl("http://d.hiphotos.baidu.com/imgad/pic/item/d833c895d143ad4b1545538e8a025aafa40f0610.jpg");
...
//        }
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        if (newConfig.orientation == Configuration.ORIENTATION_PORTRAIT) {
            ...
            Toast.makeText(WebviewVrActivity.this, "请横屏观看vr效果", Toast.LENGTH_SHORT).show();
        }
        if (newConfig.orientation == Configuration.ORIENTATION_LANDSCAPE) {
            setFullScreen();
            Toast.makeText(WebviewVrActivity.this, "马上进入vr模式", Toast.LENGTH_SHORT).show();
            if (wb != null) {

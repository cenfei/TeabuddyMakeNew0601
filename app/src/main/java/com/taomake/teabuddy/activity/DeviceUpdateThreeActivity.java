 ...
 */
@EActivity(R.layout.cm_device_update_three)
public class DeviceUpdateThreeActivity extends BaseActivity {

    @Pref
    ConfigPref_ configPref;
    @ViewById(R.id.update_process_sucess_text)
    TextView update_process_sucess_text;

    @ViewById(R.id.update_process_success_rel)
    RelativeLayout update_process_success_rel;
    @ViewById(R.id.update_process_rel)
...
//        initdata();
    ...
    protected void initActivityName() {
        activityName = DeviceUpdateThreeActivity.class.getName();
    }

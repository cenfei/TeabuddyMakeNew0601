 ...
 */
@EActivity(R.layout.cm_device_update)
...
//    RelativeLayout no_data_id;
    ...
    void onone_text_line() {
        ...
        Util.startActivity(DeviceUpdateActivity.this,DeviceUpdateTwoActivity_.class);
finish();
    }
...
//        initdata();
    ...
    protected void initActivityName() {
        activityName = DeviceUpdateActivity.class.getName();
    }
